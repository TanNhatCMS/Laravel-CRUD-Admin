...
use Backpack\CRUD\PanelTraits\FeatureAccess;
...
class CrudPanel
{
    use Create, Read, Search, Update, Delete, Errors, Reorder, Columns, Fields, Query, Buttons, AutoSet, FakeFields, FakeColumns, ViewsAndRestoresRevisions, AutoFocus, Filters, Tabs, Views, FeatureAccess;
    ...
    public $enabled = ['list', 'create', 'update', 'delete'/* 'revisions', reorder', 'show', 'details_row' */];
