@if ($crud->hasAccess('update'))
	...
	<!-- Single edit button -->
	<a href="{{ url($crud->route.'/'.$entry->getRouteKey().'/edit') }}" class="btn btn-sm btn-link"><i class="fa fa-edit"></i> {{ trans('backpack::crud.edit') }}</a>

	@else

	<!-- Edit button group -->
	<div class="btn-group">
	  <a href="{{ url($crud->route.'/'.$entry->getRouteKey().'/edit') }}" class="btn btn-sm btn-link pr-0"><i class="fa fa-edit"></i> {{ trans('backpack::crud.edit') }}</a>
