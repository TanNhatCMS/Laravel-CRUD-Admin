...
@section('header')
	<section class="content-header">
	  <h1>
	    ...
	    <small>{{ is_null($crud->entity_gender) ? trans('backpack::crud.all') : trans('backpack::crud.all_'.$crud->entity_gender) }} <span>{{ $crud->entity_name_plural }}</span> {{ trans('backpack::crud.in_the_database') }}.</small>
	  </h1>
	  <ol class="breadcrumb">
